...
import { X, Volume2, HardDrive, AlertTriangle, MessageSquare, Heart, Eye } from 'lucide-react';
...
export function SettingsModal({
  ...
  const [installPath, setInstallPath] = useState('D:\\Games\\DDNet');
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="flex space-x-2">
                      ...
                      />
                      <button
                        onClick={() => setInstallPath('D:\\Games\\DDNet')}
              ...
              {activeTab === '关于' && (
                <div className="space-y-4 text-xs text-gray-400 leading-relaxed">
                  ...
                  <div className="flex items-center space-x-3 p-1">
                    ...
                    <div>
                      <span className="text-white font-medium block">DDNet Manager</span>
                      <p className="text-[10px] text-gray-500 font-mono mt-0.5">Build version: 1.0.42_STABLE_AI_BUILD</p>
                    </div>
                  </div>

                  <p className="pt-2">面向 DDNet / QmClient 玩家的第三方客户端启动器与管理器，负责发现本机客户端、管理更新源、启动默认客户端和维护安装记录。</p>
                  
                  <div className="h-[1px] bg-white/5 my-3" />
                  
                  <p className="text-[10px] text-gray-600 block text-center">DDNet Manager third-party launcher.</p>
                </div>
              )}
            </div>
      ...
      <div className="absolute inset-0 isolate flex items-center justify-center z-50">
        ...
        >
          ...
          <p className="text-sm text-gray-300">
            你点击了关闭面板。请选择接下来 DDNet Manager 的处理模式：
          </p>
          ...
          <div className="flex flex-col space-y-2.5">
            ...
            >
              ...
              <div>
                <span className="font-semibold block">最小化到任务栏 (推荐)</span>
                <span className="text-[10px] text-gray-500 mt-0.5">隐藏主窗口到任务栏，使安装更新与下载能在后台安静完成</span>
              </div>
            </button>
